...
void TestScene::Enter()
{
...

	{
		...
		auto& animator = mTestEntity.AddComponent<AnimatorComponent>(ResourceManager::GetSkeleton(L"Assets/Skeletons/Character.skel"));
		ClientSystems::PlayAnimation(&animator, ResourceManager::GetAnimation(L"Assets/Animations/Walking.anim"), 1.0f, true);
	}
